...
# if(CACHE_BINARY)
#     message(STATUS "${CACHE_BINARY} version ${ccache_VERSION} found and enabled")
...
#
#     # Method 2: Set environment variables (ccache reads these automatically)
#     # This is often more robust and recommended for hash_dir/base_dir.
#     set(ENV{CCACHE_NOHASHDIR})
#     if(DEFINED ENV{HOME})
#         set(ENV{CCACHE_BASEDIR} "$ENV{HOME}") # Use HOME if defined
#     elseif(DEFINED ENV{CI_PROJECT_DIR})
#          set(ENV{CCACHE_BASEDIR} "$ENV{CI_PROJECT_DIR}") # Example for GitLab CI
#     elseif(DEFINED ENV{GITHUB_WORKSPACE})
#          set(ENV{CCACHE_BASEDIR} "$ENV{GITHUB_WORKSPACE}") # Example for GitHub Actions
#     # Add more conditions for your specific CI/dev environments if needed
#     else()
#         message(WARNING "Could not determine a suitable CCACHE_BASEDIR automatically.")
#     endif()
#     # Ensure base_dir exists (ccache might require this)
#     if(DEFINED ENV{CCACHE_BASEDIR} AND NOT IS_DIRECTORY "$ENV{CCACHE_BASEDIR}")
#         message(WARNING "CCACHE_BASEDIR '$ENV{CCACHE_BASEDIR}' is not a directory.")
#     endif()
# else()
